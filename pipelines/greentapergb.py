...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__rgb_threshold_red = [55.03597122302158, 146.21160409556316]
        self.__rgb_threshold_green = [98.60611510791367, 255.0]
        self.__rgb_threshold_blue = [57.32913669064748, 255.0]
